...
final class FlowKt__ErrorsKt$catchImpl$2<T> implements kotlinx.coroutines.flow.FlowCollector {
    ...
    public FlowKt__ErrorsKt$catchImpl$2(kotlinx.coroutines.flow.FlowCollector<? super T> flowCollector, kotlin.jvm.internal.Ref.ObjectRef<java.lang.Throwable> objectRef) {
    ...
    */
    public final java.lang.Object emit(T t, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        if (continuation instanceof kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$2$emit$1) {
            ...
            if ((flowKt__ErrorsKt$catchImpl$2$emit$1.label & kotlin.jvm.internal.IntCompanionObject.MIN_VALUE) != 0) {
                flowKt__ErrorsKt$catchImpl$2$emit$1.label -= kotlin.jvm.internal.IntCompanionObject.MIN_VALUE;
