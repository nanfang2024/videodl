...
final class AdjustedTimeMark implements kotlin.time.TimeMark {
    ...
    public kotlin.time.TimeMark mo962minusLRDsOJo(long j) {
        return kotlin.time.TimeMark.DefaultImpls.m1108minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo961elapsedNowUwyO8pc() {
        return kotlin.time.Duration.m1006minusLRDsOJo(this.mark.mo961elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public kotlin.time.TimeMark mo964plusLRDsOJo(long duration) {
        return new kotlin.time.AdjustedTimeMark(this.mark, kotlin.time.Duration.m1007plusLRDsOJo(this.adjustment, duration), null);
    }
}
