...
public final class ArrayDeque<E> extends kotlin.collections.AbstractMutableList<E> {
    ...
    public void clear() {
        ...
        int i = this.head;
        if (i < positiveMod) {
            kotlin.collections.ArraysKt.fill(this.elementData, (java.lang.Object) null, i, positiveMod);
        } else if (!isEmpty()) {
            java.lang.Object[] objArr = this.elementData;
            kotlin.collections.ArraysKt.fill(objArr, (java.lang.Object) null, this.head, objArr.length);
            kotlin.collections.ArraysKt.fill(this.elementData, (java.lang.Object) null, 0, positiveMod);
        }
        this.head = 0;
        this.size = 0;
    }
