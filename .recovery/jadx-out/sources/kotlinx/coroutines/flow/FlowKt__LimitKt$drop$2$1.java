...
final class FlowKt__LimitKt$drop$2$1<T> implements kotlinx.coroutines.flow.FlowCollector {
    ...
    public FlowKt__LimitKt$drop$2$1(kotlin.jvm.internal.Ref.IntRef intRef, int i, kotlinx.coroutines.flow.FlowCollector<? super T> flowCollector) {
        this.$skipped = intRef;
        this.$count = i;
    ...
    */
    public final java.lang.Object emit(T t, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        if (continuation instanceof kotlinx.coroutines.flow.FlowKt__LimitKt$drop$2$1$emit$1) {
            ...
            if ((flowKt__LimitKt$drop$2$1$emit$1.label & kotlin.jvm.internal.IntCompanionObject.MIN_VALUE) != 0) {
                flowKt__LimitKt$drop$2$1$emit$1.label -= kotlin.jvm.internal.IntCompanionObject.MIN_VALUE;
