...
final class FlowKt__EmittersKt$onEmpty$1$1<T> implements kotlinx.coroutines.flow.FlowCollector {
    ...
    public FlowKt__EmittersKt$onEmpty$1$1(kotlin.jvm.internal.Ref.BooleanRef booleanRef, kotlinx.coroutines.flow.FlowCollector<? super T> flowCollector) {
    ...
    */
    public final java.lang.Object emit(T t, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        if (continuation instanceof kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$1$1$emit$1) {
            ...
            if ((flowKt__EmittersKt$onEmpty$1$1$emit$1.label & kotlin.jvm.internal.IntCompanionObject.MIN_VALUE) != 0) {
                flowKt__EmittersKt$onEmpty$1$1$emit$1.label -= kotlin.jvm.internal.IntCompanionObject.MIN_VALUE;
