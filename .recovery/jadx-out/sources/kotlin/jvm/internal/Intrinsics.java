...
public class Intrinsics {
    ...
    public static void throwNpe() {
        throw sanitizeStackTrace(new kotlin.KotlinNullPointerException());
    }

    public static void throwNpe(java.lang.String str) {
        throw sanitizeStackTrace(new kotlin.KotlinNullPointerException(str));
    }
    ...
    public static void throwUninitializedProperty(java.lang.String str) {
        throw sanitizeStackTrace(new kotlin.UninitializedPropertyAccessException(str));
    }
    ...
    public static <T extends java.lang.Throwable> T sanitizeStackTrace(T t, java.lang.String str) {
